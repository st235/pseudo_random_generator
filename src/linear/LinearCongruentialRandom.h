#ifndef PSEUDO_RANDOM_FISH_LINEARCONGRUENTIALRANDOM_H
#define PSEUDO_RANDOM_FISH_LINEARCONGRUENTIALRANDOM_H
...
#endif //PSEUDO_RANDOM_FISH_LINEARCONGRUENTIALRANDOM_H
